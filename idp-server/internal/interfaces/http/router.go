...
func NewRouter(authzService authz.Service, consentService appconsent.Manager, authnService authn.Authenticator, tokenService apptoken.Exchanger, oidcService *oidc.Service, authMiddleware *middleware.AuthMiddleware) *gin.Engine {
	router := gin.New()
